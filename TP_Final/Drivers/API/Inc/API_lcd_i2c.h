...
/* Device I2C Address */
// Probar segun el tipo de LCD si no funciona, descomentar y comentar las lineas debajo.
#define DEVICE_ADDR     (0x27 << 1) // Para un modelo de LCD.
//#define DEVICE_ADDR     (0x4E << 1) // Para un modelo de LCD.
//#define DEVICE_ADDR     (0x3F << 1) // Para un modelo de LCD.
//#define DEVICE_ADDR     (0x27) // Para un modelo de LCD.
//#define DEVICE_ADDR     (0x4E) // Para un modelo de LCD.
//#define DEVICE_ADDR     (0x3F) // Para un modelo de LCD.
